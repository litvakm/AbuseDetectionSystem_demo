...
ap.add_argument("-i", "--input",help="path to input video", default=None)
...
class YOLO_V3(object):
    def __init__(self):
        ...
        self.anchors_path = r'./model_data/yolo_anchors.txt'
        self.classes_path = r'./model_data/coco_classes.txt'
        #具体参数可实验后进行调整
